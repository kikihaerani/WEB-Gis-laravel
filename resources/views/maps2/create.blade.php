      ...
      <div class="max-w-md w-full space-y-8">
        <form class="mt-8 space-y-6" action="/maps" method="post">
          ...
          <div class="rounded-md shadow-sm -space-y-px">
            ...
            <div>
              <label for="kategori" class="sr-only">Kategri</label>
                  ...
                  @foreach ($maps as $m)
                    <tr>
                      ...
                      <td class="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                        <a href="{{$m->id}}/edit"
                          class="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-black bg-blue-600 hover:bg-blue-800">
                          Edit Data
                        </a>
                        <form action="{{$m->id}}"
                          method="post">
                          ...
                          @csrf
                          <button type="submit"
                            class="mt-2 group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-black bg-blue-600 hover:bg-blue-800">
                            Hapus Data
                          </button>
                        </form>
                      </td>
